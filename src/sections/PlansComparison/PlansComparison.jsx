...
const PlansComparison = () => {
  ...
  const tabsItems = headCells
    ...
    .map((headCell, headCellIndex) => ({
      ...
      children: (
        <Specifications
          items={rows.map(({ cells, isWide}, rowIndex) => ({
            key: cells[0],
  ...
  return (
    <Section
      ...
      description='StreamVibe offers three different plans to fit your needs: Basic, Standard, and Premium. Compare the features of each plan and choose the one that is right for you.'
    >
      <Table
